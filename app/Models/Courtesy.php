...
class Courtesy extends Model
{
    ...
    public function get_list()
    {
        ...
        if ($rol_id != 1 && !in_array('g_courtesies', $this->session->get('permissions')))
        {
        ...
        if ($response->code == 200)
        {
            ...
            foreach ($rows as $row)
            {
                ...
                if ($rol_id == 1 || in_array('u_courtesies', $this->session->get('permissions')))
                {
                ...
                if ($rol_id == 1 || in_array('d_courtesies', $this->session->get('permissions')))
                {
                    if ($row->active_status == 1) 
                    {
