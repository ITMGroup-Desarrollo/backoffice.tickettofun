...
class Reseller extends Model
{
    ...
    public function get_list()
    {
        ...
        if ($rol_id != 1 && !in_array('g_resellers', $this->session->get('permissions')))
        {
        ...
        if ($response->code == 200)
        {
            ...
            foreach ($rows as $row)
            {
                ...
                if ($rol_id == 1 || in_array('u_resellers', $this->session->get('permissions')))
                {
                ...
                if($rol_id == 1 || in_array('d_resellers', $this->session->get('permissions')))
                {
                    if ($row->active_status == 1) 
                    {
