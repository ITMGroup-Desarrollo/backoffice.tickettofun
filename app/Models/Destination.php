...
class Destination extends Model
{
    ...
    public function get_list()
    {
        ...
        if ($rol_id != 1 && !in_array('g_destinations', $this->session->get('permissions')))
        {
        ...
        if ($response->code == 200)
        {
            ...
            foreach ($rows as $row)
            {
                ...
                if ($rol_id == 1 || in_array('u_destinations', $this->session->get('permissions')))
                {
                ...
                if ($rol_id == 1 || in_array('d_destinations', $this->session->get('permissions')))
                {
                    if ($row->active_status == 1) 
                    {
